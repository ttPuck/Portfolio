<template >
    <section class="relative py-20 overflow-hidden" id="projects">
        <div class="relative z-10 max-w-8xl mx-auto px-4 sm:6
        lg:px-8">
        ...
        :key="(project.id)"
        class="group relaive bg-linear-to-br from-gray-600/50
        to-blue-900/30 rounded-3xl overflow-hidden border backdrop-blur-sm
        hover:border-blue-400/30 transition-all duration-500  hover:transform
        hover:-translate-y-2"
...
const projects = ref([
    {
        ...
        links: [
            {name: "Website", url: "https://romansroad.netlify.app", icon: EyeIcon,
    ...
    },
      {
        ...
        links: [
            {name: "Website (Sign-up and Login)", url: "#", icon: EyeIcon,
                class: 'text-white hover:text-blue-300'
            },
             {name: "Github Repo", url: "#", icon: CodeBracketIcon,
                class: 'text-white hover:text-blue-300'
            },
        ]
    },
     {
        ...
        links: [
            {name: "Github Repo & Installer", url: "#", icon: ArrowDownTrayIcon,
                class: 'text-white hover:text-blue-300'
            },
        ]
    },
