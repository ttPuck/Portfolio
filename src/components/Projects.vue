        ...
        >
          <div class="relative overflow-hidden">
            ...
            <div class="absolute top-4 right-4">
              <span
                class="px-3 py-1 text-white text-xs rounded-full font-semibold"
                :class="webproject.badgeColor"
              >
                {{ webproject.category }}
              </span>
            </div>
          ...
          <div class="p-6">
            ...
            <div class="flex flex-wrap gap-2 mb-4">
              <span
                v-for="tech in webproject.technolg"
                :key="tech"
    ...
    <div class="relative z-10 max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3  gap-8">
        ...
        >
          ...
          <div class="p-6">
            ...
            <div class="flex flex-wrap gap-2 mb-4">
              <span
                v-for="tech in otherproject.technolg"
                :key="tech"
                class="px-2 py-1 border rounded text-xs"
                :class="tech.class"
              >
      ...
      <div class="text-center mt-16" data-aos="fade-up">
        <div class="inline-flex flex-col sm:flex-row gap-4 items-center">
          ...
          target="_blank"
            class="px-8 py-4 rounded-xl bg-[#5386e4] text-white font-semibold hover:shadow-lg hover:shadow-[#b14aed] transition-all duration-300 hover:scale-105 flex items-center"
          >
            View GitHub!
